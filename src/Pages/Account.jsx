...
export default function RegisterUser() {
    ...
    const HandleLogin = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${envConfig.keyChangeUrl}/api/login`, { email, password }, config);
    ...
    const HandleRegistration = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${envConfig.keyChangeUrl}/api/signup`, { name, email, password, avatar }, config);
        ...
        <div className="container-fluid" id="Wrapper">
            <div className="row d-flex flex-column justify-content-center align-items-center w-100 h-100 m-0">
                ...
                <div id="Minor_Wrapper" className="mb-2 py-3">
                    <h4 className="m-0 text-center text-white">Lets-Chat by RoxsRoss</h4>
                </div>
